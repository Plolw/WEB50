# Generated by Django 4.2.4 on 2023-09-11 20:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('EL', 'Electronics'), ('HM', 'Home'), ('TY', 'Toys'), ('FS', 'Fashion'), ('OT', 'Other')], default='OT', max_length=20)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings', to=settings.AUTH_USER_MODEL)),
                ('watchers', models.ManyToManyField(blank=True, related_name='watchlisted', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
